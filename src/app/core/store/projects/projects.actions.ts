...
export const loadProjects = createAction('[Projects] Load Projects', props<{ filters?: ProjectFilters }>());
export const loadProjectsSuccess = createAction('[Projects] Load Projects Success', props<{ response: PaginatedResponse<Project> }>());
...
export const loadProjectSuccess = createAction('[Projects] Load Project Success', props<{ project: Project }>());
export const loadProjectFailure = createAction('[Projects] Load Project Failure', props<{ error: string }>());

export const createProject = createAction('[Projects] Create Project', props<{ data: ProjectCreate }>());
...
export const updateProject = createAction('[Projects] Update Project', props<{ id: string; data: ProjectUpdate }>());
...
export const setProjectFilters = createAction('[Projects] Set Filters', props<{ filters: ProjectFilters }>());
