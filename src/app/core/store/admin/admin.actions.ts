...
export const loadUsers = createAction('[Admin] Load Users', props<{ page: number; limit: number }>());
...
export const updateUserRole = createAction('[Admin] Update User Role', props<{ userId: string; role: string }>());
export const updateUserRoleSuccess = createAction('[Admin] Update User Role Success');
export const updateUserRoleFailure = createAction('[Admin] Update User Role Failure', props<{ error: string }>());

export const toggleUserKyc = createAction('[Admin] Toggle User KYC', props<{ userId: string; verified: boolean }>());
export const toggleUserKycSuccess = createAction('[Admin] Toggle User KYC Success');
export const toggleUserKycFailure = createAction('[Admin] Toggle User KYC Failure', props<{ error: string }>());

export const updateConfig = createAction('[Admin] Update Config', props<{ config: Record<string, number> }>());
export const updateConfigSuccess = createAction('[Admin] Update Config Success');
export const updateConfigFailure = createAction('[Admin] Update Config Failure', props<{ error: string }>());
